...
public class EnemySpawner : MonoBehaviour
{
    ...
    [SerializeField] float[][] enemyProbabilities = {
        ...
        new float[] { 0.35f, 0.25f, 0.15f, 0.25f, 0.00f, 0.00f, 0.00f, 0.00f},
        new float[] { 0.20f, 0.25f, 0.15f, 0.20f, 0.20f, 0.00f, 0.00f, 0.00f},
        ...
        new float[] { 0.00f, 0.65f, 0.35f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f},
        new float[] { 0.00f, 0.65f, 0.35f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f},
        new float[] { 0.00f, 0.15f, 0.15f, 0.15f, 0.15f, 0.15f, 0.10f, 0.15f},// добавить: босс, тут впринципе 1 заспавнил а дальше как в обычной волне
    ...
    private double[] healthScale = { 1,1.2,1.4,1.6,1.8,2,2.2,2.4,2.6,2.8,3};
