...
public class EnemySpawner : MonoBehaviour
{
    ...
    public float[] waveDuration; // Длительность волны (в секундах)
    public int[] minEnemiesPerWave;
    public int[] maxEnemiesPerWave; // Максимальное количество врагов за волну
    ...
    private int enemiesSpawnedThisWave = 0; // Количество врагов, заспавненных на текущей волне

    public int[] pointsPerWave; // Очки для спавна врагов на волне
    ...
    [SerializeField] float[][] enemyProbabilities = {
        new float[] { 1.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f}, // 1 волна
        new float[] { 0.75f, 0.25f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f}, // 2 волна, немного мелких чтоб не скучали
        new float[] { 0.00f, 0.65f, 0.35f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f},// первый тест, волна только с мелкими чтоб проверить скорость нанесения урона и умение убегать (уровень 3 +-)
        new float[] { 0.55f, 0.25f, 0.15f, 0.00f, 0.00f, 0.00f, 0.00f, 0.00f},//передых, даем собрать улучшения
        new float[] { 0.00f, 0.00f, 0.00f, 0.45f, 0.00f, 0.00f, 0.25f, 0.25f}, // тут учим игрока держаться на дистанции, чтобы не быть захуканым к толпе обычек + проверяем умение держаться на расстоянии (к этой/ к концу волны должно быть примерно одно фуловое и одно 1 го лвл)
        new float[] { 0.35f, 0.05f, 0.10f, 0.25f, 0.00f, 0.00f, 0.15f, 0.10f},// немного старых врагов чтоб игрок следил за всем
        new float[] { 0.25f, 0.00f, 0.20f, 0.25f, 0.00f, 0.00f, 0.15f, 0.15f},// убираем одиночных мелких, а так снова чилл волна, чтоб игрок точно был хотяб с 2 прокачаными в фул оружиями;
        new float[] { 0.15f, 0.00f, 0.00f, 0.00f, 0.35f, 0.35f, 0.15f, 0.15f},// иллюзионисты и стреляющие, к которым нужно подходить, доджа пули, полная противоположность 11 волне
        new float[] { 0.05f, 0.00f, 0.05f, 0.25f, 0.10f, 0.25f, 0.10f, 0.10f},//уже хаос но с направлениями во взрывы и снаряды
        new float[] { 0.00f, 0.10f, 0.15f, 0.15f, 0.15f, 0.15f, 0.15f, 0.15f},// последний рывок и полный хаос (тут очевидно уже фул прокачка)
    };
