...
public class EnemySpawner : MonoBehaviour
{
    ...
    [SerializeField] float[][] enemyProbabilities = {
        ...
        new float[] { 0.00f, 0.00f, 0.00f, 0.45f, 0.00f, 0.15f, 0.15f, 0.25f}, // тут учим игрока держаться на дистанции, чтобы не быть захуканым к толпе обычек + проверяем умение держаться на расстоянии (к этой/ к концу волны должно быть примерно одно фуловое и одно 1 го лвл)
